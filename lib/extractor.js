...
var parseUrl = function* (url) {
  ...
  if (type <= 1) {
    var resp = yield axios.head(url, {
        // fixes https://github.com/axios/axios/pull/1384 for this request
        transport: {
          request: _.wrap(URL.parse(url).protocol == 'https:' ? https.request : http.request, function (request, options, callback) {
